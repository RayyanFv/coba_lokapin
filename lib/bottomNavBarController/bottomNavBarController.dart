  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(icon: Image.asset('assets/homeIcon.png',width: 21,),label: 'Home', activeIcon: Image.asset('assets/home.png', width: 21,)),
            BottomNavigationBarItem(icon: Image.asset('assets/communityIcon.png', width: 20,),label: 'Community'),
            BottomNavigationBarItem(icon: Image.asset('assets/locationIcon.png', width: 20,),label: 'Tracking'),
